...
class TestSmokeTest():
    ...
    def test_smoke2(self):
        ...
        self.driver.set_window_size(1294, 1039)
        assert self.driver.find_element(
            By.CSS_SELECTOR, ".spotlight1 > h4").text == "Teton Elementary"
        elements = self.driver.find_elements(
            By.CSS_SELECTOR, ".spotlight1 img")
        assert len(elements) > 0
        assert self.driver.find_element(
            By.CSS_SELECTOR, ".spotlight2 > h4").text == "Teton Post Office"
        elements = self.driver.find_elements(
    ...
    def test_smoke3(self):
        ...
        assert self.driver.find_element(
            By.CSS_SELECTOR, ".gold-member:nth-child(9) > p:nth-child(2)").text == "Teton Turf and Tree"
        assert self.driver.find_element(
            By.CSS_SELECTOR, ".gold-member:nth-child(9) a").text == "Website"
    ...
    def test_smoke4(self):
        ...
        self.driver.find_element(
            By.NAME, "biztitle").send_keys("Software Engineer")
